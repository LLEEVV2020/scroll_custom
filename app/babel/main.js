...
slider.on('mouseup', function () {//console.log("good");
...
slider.on('mousedown', function (eventObject) {
  ...
  $(this).find(".bga").mousemove(function (e) {
    if (ifWider($(this))) {
      ...
      makeScroll2($(this).parents(".wrapper"), x); //console.log( x + ' - Вы нажали на кнопку мыши, над элементом "foo". Код нажатой клавиши - ' + eventObject.which);
    }
  });
});
